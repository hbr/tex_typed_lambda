...
\begin{theorem}
    ...
    \begin{proof} By induction on $a \preduce b$.
        ...
        \preduce k$ and do induction on this relation.
            ...
            properties $e \preduce g$ and $a \preduce c$ and the induction
            hypotheses $\exists h. f \preduce h \land g \preduce h$ and $\exists d.
            b \preduce d \land c \preduce d$.
