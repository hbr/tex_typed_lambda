...
\begin{theorem}
    ...
    \begin{enumerate}
        ...
        \item We define a parallel beta reduction relation $\preduce$ which is a
        superset of the beta reduction relation $\reduce$ i.e.  $(\reduce)
        \subseteq
        ...
        \subseteq (\reducestar)$ (lemma~\ref{ParallelReductionLeReductionStar}).
        ...
        \begin{enumerate}
            ...
            \item idempotent $(r^*)^* = r$
        \end{enumerate}
        to see that $(\reducestar) \subseteq (\preducestar)$ and $(\preducestar)
        \subseteq
