...
\begin{theorem}
    ...
    \begin{proof}
        We proof only the theorem for products, because the proof for
        abstraction is practically the same.
        ...
        preserved by beta reduction. Therefore the common reduct must have the
        form $\Pi x^E.F$ with $A \reducestar E$, $B \reducestar F$, $C
