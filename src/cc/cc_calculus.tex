...
In many texts about typed lambda calculus like e.g. \cite{barendregt1993} and
\cite{geuvers1994} the symbol $*$ is used instead of $\Prop$ and the symbol
$\Box$ is used instead of $\Any$. This has found its way into the Haskell
programming language where $*, * \to *, (* \to *) \to *, \ldots$ are
\emph{kinds}.
