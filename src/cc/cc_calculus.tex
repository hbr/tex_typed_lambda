...
\begin{definition}
    ...
    In other words the beta betaeqalence relation $\betaeq$ is the smallest
    betaeqalence relation which contains beta reduction $\reduce$.
\end{definition}
...
\begin{theorem}
    ...
    \begin{proof}
        ...
        The first case is trivial, because $t$ and $u$ are identical.

        For the other two case the goal is a consequence of the induction
        hypothesis and the transitivity of beta equivalence.
    \end{proof}
\end{theorem}
