...
\begin{theorem}
    ...
    \emph{Every syntactical kind in the type position of a typing judgement has
    type $\Any$}.
    $$
    \rulev{
        K \in \Kinds
    ...
    \begin{proof}
        ...
        valid for some sort $s$. Only the latter is possible.

        By the previous theorem~\ref{KindImpliesTypeAny} we infer the goal.
    \end{proof}
\end{theorem}
